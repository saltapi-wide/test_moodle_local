...
//test
//echo $this->html_is_blank("<div class='123' style='color: red;'>123dxsD</div>");
//exit;
//end test
...
if (!empty($CFG->enabledevicedetection) && empty($device)) {
    ...
    foreach ($devices as $thedevice) {
        ...
        if ($themename) {
            ...
            if (empty($themename)) {
                ...
                $screenshotcell = html_writer::empty_tag('pix', array('class' => 'pix-responsive pix-fluid',
    ...
    foreach ($themes as $themename => $themedir) {
        ...
        $row[] = html_writer::empty_tag('pix', array('class' => 'pix-responsive pix-fluid',
