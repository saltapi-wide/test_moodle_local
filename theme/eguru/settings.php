...
if (is_siteadmin()) {
    ...
    $themepattern = '<ul class="thumbnails theme-color-schemes"><li class=""><div class="thumbnail"><pix src="'.$pimg[0].'" alt="default" width="100" height="100"/><h6>'.get_string( "default", 'theme_eguru' ).'</h6></div></li><li class=""><div class="thumbnail"><pix src="'.$pimg[1].'" alt="pattern1" width="100" height="100"/><h6>'.get_string("color_1", 'theme_eguru').'</h6></div></li><li class=""><div class="thumbnail"><pix src="'.$pimg[2].'" alt="pattern2" width="100" height="100"/><h6>'.get_string("color_2", 'theme_eguru').'</h6></div></li><li class=""><div class="thumbnail"><pix src="'.$pimg[3].'" alt="pattern3" width="100" height="100"/><h6>'.get_string("color_3", 'theme_eguru').'</h6></div></li><li class=""><div class="thumbnail"><pix src="'.$pimg[4].'" alt="pattern4" width="100" height="100"/><h6>'.get_string("color_4", 'theme_eguru').'</h6></div></li></ul>';
