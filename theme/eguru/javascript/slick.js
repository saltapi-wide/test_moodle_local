...
(function(factory) {
    ...
    Slick.prototype.buildOut = function() {
        ...
        $('pix[data-lazy]', _.$slider).not('[src]').addClass('slick-loading');
    ...
    Slick.prototype.lazyLoad = function() {
        ...
        function loadImages(imagesScope) {
            $('pix[data-lazy]', imagesScope).each(function() {
                var image = $(this),
    ...
    Slick.prototype.progressiveLazyLoad = function() {
        ...
        imgCount = $('pix[data-lazy]', _.$slider).length;

        if (imgCount > 0) {
            targetImage = $('pix[data-lazy]', _.$slider).first();
