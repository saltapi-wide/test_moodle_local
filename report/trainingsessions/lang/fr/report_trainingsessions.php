...
$string['trainingsessions:view'] = 'Peut consulter le rapport des sessions de formation'; // @DYNAKEY
$string['trainingsessions:viewother'] = 'Peut consulter les rapports de session des autres'; // @DYNAKEY
$string['trainingsessions:iscompiled'] = 'Apparaît dans les rapports'; // @DYNAKEY
$string['trainingsessions:downloadreports'] = 'Peut télécharger les rapports'; // @DYNAKEY
...
$string['availableactivities'] = 'Activités possibles';
$string['batchdate'] = 'Date de la tâche';
$string['batchreports_task'] = 'Rapports différés'; // @DYNAKEY
...
$string['checklistadvice'] = 'Effet de bords sur la completion'; // @DYNAKEY
...
$string['exthits'] = 'Evénéments (Etendu)'; // @DYNAKEY
$string['exthitslastweek'] = 'Evénéments dern. semaine (Etendu)'; // @DYNAKEY
$string['extotherelapsed'] = 'Temps complémentaires'; // @DYNAKEY
$string['extotherlastweek'] = 'Temps complémentaires (dernière semaine)'; // @DYNAKEY
...
$string['hits'] = 'Evénéments '; // @DYNAKEY
$string['hitslastweek'] = 'Hits dernière semaine'; // @DYNAKEY
$string['id'] = 'ID';
...
$string['ltcprogressinmandatoryitems'] = 'Prog. du contrat pédag. (% obligatoires)';
...
$string['othertime'] = 'Autres temps de session ';
$string['out'] = 'Temps extra ';
$string['outofgroup'] = 'Hors groupe';
$string['elapsedoutofstructure'] = 'Autres temps du cours ';  // @DYNAKEY
...
$string['pdfpage'] = 'Page : ';
$string['pdfpagecutoff'] = 'Hauteur de page PDF';
$string['pdfpagecutoff_desc'] = 'Hauteur à laquelle le saut de page est généré (dépend de la taille du pied de page - en mm).';
...
$string['printlocation'] = 'Lieu de la formation';
$string['printlocation_desc'] = 'Le lieu de formation à imprimer sur les rapports (lorque supporté)';
...
$string['reportformat'] = 'Format du document';
$string['reportforuser'] = 'Rapport pour ';
$string['reportlayout'] = 'construction du rapport';
$string['reports'] = 'Rapports de formation';
$string['reportscope'] = 'Portée';
$string['role'] = 'Rôle';
$string['scheduledbatches'] = 'Batchs enregistrés';
$string['scoresettings'] = 'Ajout de notes aux rapports';
$string['scoresettingsadvice'] = 'Dans les rapports résumés de cours (un utilisateur par ligne), des notes du carnet de notes peuvent être ajoutées à la sortie. Il est possible d\'ajouter la note globale du cours ou la note d\'une (ou plusieurs) activité(s) particulière(s) (par exemple un quiz évaluatif)';
...
$string['sessionreportdoctitle'] = 'Rapport de sessions';
...
$string['showhits_desc'] = 'Si activé, le nombre d\'événements est affiché dans les sorties CSV';
$string['showitemfirstaccess'] = 'Afficher les dates de premier accès';
$string['showitemfirstaccess_desc'] = 'Si activé, affiche les dates de premier accès à chaque item. Ces dates sont les dates réelles des historiques.';
$string['showitemlastaccess'] = 'Afficher les dates de dernier accès';
$string['showitemlastaccess_desc'] = 'Si activé, affiche les dates de dernier accès à chaque item. Ces dates sont les dates réelles des historiques.';
$string['showmonthlyquickreports'] = 'Générer les rapports mensuels';
$string['showmonthlyquickreports_desc'] = 'Si activé, les liens vers les extractions pdf "par mois" sont visibles sur le rapport de détail.';
$string['showsectionsonly'] = 'Montrer uniquement les sections';
$string['showsectionsonly_desc'] = 'Si activé, alors les rapports n\'afficheront plus niveau de détail "élément". Seules les données agrégées de sections seront visibles.';
$string['showsessions'] = 'Voir le detail des sessions';
$string['showsessions_desc'] = 'Si activé, le détail des sessions est accessible dans les rapports';
$string['showsseconds'] = 'Afficher les secondes';
$string['showsseconds_desc'] = 'Si activé, affiche les secondes dans les durées.';
...
$string['insessiontime_help'] = 'Ceci est le temps correspondant aux règles de validation.';

$string['outsessiontime_help'] = 'Ceci est le temps hors règles de validation.';
...
<p>Vous pouvez mentionner ici un sous-répertoire où stocker les productions documentaires. Notez que le contexte de stockage de ce sous-répertoire
 sera toujours le cours dans lequel vous avez programé le batch, même si la portée de compilation choisie est "Tous les cours"</p>
';

$string['batchdate_help'] = '
<p>Ce réglage détemrine la date exacte à laquelle les documents du batch seront générés. Si vous craignez que cette production soit lourde
 à exécuter (beaucoup d\'étudiants, beaucoup d\'activité, beaucoup de cours), choisissez une date et une heure de faible charge de votre serveur.</p>
';

$string['replaydelay_help'] = '
<p>Si réglé à une valeur positive (en minutes), ce batch ne sera pas supprimé après exécution, mais remis en jeu décalé de ce délai. Les dates
 de début et de fin seront décalées de la même durée si la répétition est réglée sur une période glissante.</p>
';
...
Le temps passé dans le cours, mais en dehors de la "structure" du cours (sections, pages, activités).';
