		...
		editor.onKeyDown.add(function(editor, e) {
			...
			if (!isDefaultPrevented(e) && (isDelete || e.keyCode == BACKSPACE) && !VK.modifierPressed(e)) {
				...
				if (container.nodeType == 3 && container.nodeValue.length > 0 && ((offset === 0 && !collapsed) || (collapsed && offset === (isDelete ? 0 : 1)))) {
					// Edge case when deleting <p><b><pix> |x</b></p>
	...
	function fakeImageResize() {
		...
		editor.contentStyles.push(
			...
			'.mceResizeHandle:hover {' +
				'background: #000' +
			'}' +
			'pix[data-mce-selected] {' +
				'outline: 1px solid black' +
			'}' +
			'pix.mceClonedResizable, table.mceClonedResizable {' +
				'position: absolute;' +
		...
		function updateResizeRect() {
			var controlElm = dom.getParent(selection.getNode(), 'table,pix');

			// Remove data-mce-selected from all elements since they might have been copied using Ctrl+c/v
			each(dom.select('pix[data-mce-selected]'), function(img) {
...
(function(tinymce) {
	...
	function getHTML5() {
		...
		if (!html5) {
			html5 = mapCache.html5 = unpack({
					...
					B : '#|a|abbr|area|audio|b|bdo|br|button|canvas|cite|code|command|datalist|del|dfn|em|embed|i|iframe|pix|input|ins|kbd|keygen|label|link|map|mark|meta|' +
					...
					C : '#|a|abbr|area|address|article|aside|audio|b|bdo|blockquote|br|button|canvas|cite|code|command|datalist|del|details|dfn|dialog|div|dl|em|embed|fieldset|' +
						'figure|footer|form|h1|h2|h3|h4|h5|h6|header|hgroup|hr|i|iframe|pix|input|ins|kbd|keygen|label|link|map|mark|menu|meta|meter|nav|noscript|ol|object|output|' +
					...
					'figcaption[A][C]' +
					'pix[A|alt|src|height|width|usemap|ismap][]' +
	...
	function getHTML4() {
		...
		if (!html4) {
			...
			html4 = mapCache.html4 = unpack({
				...
				ZD : '[E][S]',
				U : 'ul|ol|dl|menu|dir',
				ZC : 'p|Y|div|U|W|table|br|span|bdo|object|applet|pix|map|K|N|Q',
				T : 'h1|h2|h3|h4|h5|h6',
				ZB : 'X|S|Q',
				S : 'R|P',
				ZA : 'a|G|J|M|O|P',
				...
				H : 'G|F',
				G : 'br|span|bdo',
				F : 'object|applet|pix|map|iframe',
				E : 'A|B|C',
				...
				'h1[E|align][#|S]' + 
				'pix[E|src|alt|name|longdesc|width|height|usemap|ismap|align|border|hspace|vspace][]' +
				...
				'button[E|D|name|value|type|disabled][#|p|T|div|U|W|table|G|object|applet|pix|map|K|N|Q]' +
				'h4[E|align][#|S]' + 
	...
	tinymce.html.Schema = function(settings) {
		...
		shortEndedElementsMap = createLookupTable('short_ended_elements', 'area base basefont br col frame hr pix input isindex link meta param embed source wbr');
			...
			parser = new tinymce.html.SaxParser({
				...
				start: function(name, attrs, empty) {
					...
					if (elementRule) {
						...
						// Change current node if the element wasn't empty i.e not <br /> or <pix />
						if (!empty)
							node = newNode;
			...
			function trim(node) {
				...
				if (type != 9) {
					...
					if (type == 3 && node.nodeValue.length > 0) {
						...
						// Keep non empty elements or pix, hr etc
		...
		normalize : function() {
			...
			function normalizeEndPoint(start) {
				...
				function findTextNodeRelative(left, startNode) {
					...
					// Walk left until we hit a text node we can move to or a block/br/pix
					while (node = walker[left ? 'prev' : 'next']()) {
	...
	tinymce.create('tinymce.ui.Button:tinymce.ui.Control', {
		...
		renderHTML : function() {
			...
			if (s.image && !(this.editor  &&this.editor.forcedHighContrastMode) )
				h += '<span class="mceIcon ' + s['class'] + '"><pix class="mceIcon" src="' + s.image + '" alt="' + DOM.encode(s.title) + '" /></span>' + (l ? '<span class="' + cp + 'Label">' + l + '</span>' : '');
			else
...
(function(tinymce) {
	...
	tinymce.create('tinymce.ui.SplitButton:tinymce.ui.MenuButton', {
		...
		renderHTML : function() {
			...
			if (s.image)
				h1 = DOM.createHTML('pix ', {src : s.image, role: 'presentation', 'class' : 'mceAction ' + s['class']});
			else
		...
		function defaultFormats() {
			register({
				alignleft : [
					...
					{selector : 'pix,table', collapsed : false, styles : {'float' : 'left'}}
				],
				...
				alignright : [
					...
					{selector : 'pix,table', collapsed : false, styles : {'float' : 'right'}}
				],
			...
			function isCaretAtStartOrEndOfBlock(start) {
				...
				while (node = walker.current()) {
					if (node.nodeType === 1) {
						// Ignore bogus elements
						if (!node.getAttribute('data-mce-bogus')) {
							// Keep empty elements like <pix /> <input /> but not trailing br:s like <p>text|<br></p>
							name = node.nodeName.toLowerCase();
