...
$string['imagesmissingalt'] = 'Images require alternative text. To fix this warning, add an alt attribute to your pix tags. An empty alt attribute may be used, but only when the image is purely decorative and carries no information.';
