...
var Dom = YAHOO.util.Dom,
    ...
    */
    ...
    YAHOO.extend(YAHOO.widget.SimpleEditor, YAHOO.util.Element, {
        ...
        */
        initAttributes: function(attr) {
            ...
            * @default <code><pre>html {
            ...
            pix.selected { //Safari image selection
        ...
        * @description Checks to see if a string (href or pix src) is possibly a local file reference..
        */
            ...
            if (this._isElement(el, 'img')) {
                ...
                if (this._getDoc().queryCommandEnabled(action)) {
                    ...
                    for (var i = 0; i < imgs.length; i++) {
                        if (!YAHOO.util.Dom.hasClass(imgs[i], 'yui-pix')) {
                            YAHOO.util.Dom.addClass(imgs[i], 'yui-pix');
                    ...
                    if (el == this._getDoc().body) {
                        ...
                        YAHOO.util.Dom.addClass(_img, 'yui-pix');
    ...
    /* }}} */
        ...
        _createCurrentElement: function(tagName, tagStyle) {
            ...
            if (!this._hasSelection()) {
                if (this._getDoc().queryCommandEnabled('insertimage')) {
                    this._getDoc().execCommand('insertimage', false, 'yui-tmp-pix');
                    var imgs = this._getDoc().getElementsByTagName('img');
                    for (var j = 0; j < imgs.length; j++) {
                        if (imgs[j].getAttribute('src', 2) == 'yui-tmp-pix') {
        ...
        */
        cleanHTML: function(html) {
            ...
            if (markup == 'xhtml') {
		        html = html.replace(/<YUI_IMG([^>]*)>/g, '<pix $1 />');
        ...
        */
        initAttributes: function(attr) {
            ...
            * @default <code><pre>
            ...
            .yui-hidden div, .yui-hidden p, .yui-hidden span, .yui-hidden pix, .yui-hidden ul, .yui-hidden ol,
            ...
            */            
            this.setAttributeConfig('hiddencss', {
                value: attr.hiddencss || '.yui-hidden font, .yui-hidden strong, .yui-hidden b, .yui-hidden em, .yui-hidden i, .yui-hidden u, .yui-hidden div,.yui-hidden p,.yui-hidden span,.yui-hidden pix, .yui-hidden ul, .yui-hidden ol, .yui-hidden li, .yui-hidden table { border: 1px dotted #ccc; } .yui-hidden .yui-non { border: none; } .yui-hidden pix { padding: 2px; }',
                writeOnce: true
            });
