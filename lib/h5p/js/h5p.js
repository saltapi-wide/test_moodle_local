...
(function () {
   ...
   *
   * @param {Element} element DOM element, typically pix, video or audio
  ...
  /**
   * Get the crossOrigin policy to use for pix, video and audio tags on the current site.
   *
...
H5P.Thumbnail = function (source, width, height) {
   ...
   */
  this.toString = function () {
    return '<pix src="' + source + '" alt="' + H5P.t('thumbnail') + '" class="h5p-thumbnail" height="' + thumbHeight + '"' + (thumbWidth === undefined ? '' : ' width="' + thumbWidth + '"') + '/>';
  };
};
